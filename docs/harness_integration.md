...
Real API demos should be deliberately small. The current project budget gate is `REAL_API_BUDGET_LIMIT_CNY=1.0`; use `/metrics/cost` and `/evaluation/summary` after each real run to confirm cumulative spend.
