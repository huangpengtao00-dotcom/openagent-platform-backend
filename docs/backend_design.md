...
The v0.2 local worker uses FastAPI BackgroundTasks. This keeps the demo easy to run while leaving a clear migration path to Redis Queue, Celery, Dramatiq, or a separate worker process.
